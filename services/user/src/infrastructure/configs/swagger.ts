...
import { STATUS_TAG, USER_TAG } from 'src/domain/constants/tags';
...
const getSwaggerOptions = (config: IEnvConfig): SwaggerOptions => ({
  ...
  openapi: {
    ...
    tags: [
      { name: STATUS_TAG, description: 'Service status related endpoints' },
      { name: USER_TAG, description: 'User related endpoints' },
    ],
    externalDocs: {
